...
<head>
    ...
    <title>Pavithra R - Portfolio</title>
    <style>
        body {
...
<body>
    ...
    <header>
        ...
        <img src="/storage/emulated/0/Download/i" alt="Atchaya M" class="profile-picture">
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="mail rpavithra0302@gmail.com">rpavithra0302@gmail.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 Pavithra R. All Rights Reserved.</p>
    </footer>
